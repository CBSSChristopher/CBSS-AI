...
export function buildVaEmailDraft(input: {
  ...
  if (kind === "callback") {
    return {
      ...
      text: [
        ...
        "We will call back at the window you gave us. This note is not a price and not a card link.",
  ...
  if (kind === "booked-confirm") {
    return {
      ...
      text: [
        ...
        `${closer} is the closer of record. The outbound desk does not quote a dollar and does not take cards.`,
  ...
  return {
    ...
    text: [
      ...
      "Reply if you want the closer to call. We do not invent a price in this note. We do not send a card checkout link.",
      "",
      `Closer of record: ${closer}.`,
      "",
      "This draft was not sent.",
