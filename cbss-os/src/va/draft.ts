...
export function buildVaEmailDraft(input: {
  ...
  if (kind === "booked-confirm") {
    return {
      ...
      text: [
        ...
        "Residential and business shipping containers. Payment talk, if it comes up: wire / ACH / e-check / money order / cashier's check / cash.",
        "",
  ...
  return {
    ...
    to,
    sent: false,
    subject: "CB Shipping Solutions — shipping containers",
    text: [
      `Hi ${name},`,
      "",
      "Draft intro from the CB Shipping Solutions outbound desk. We set appointments for residential and business shipping containers.",
