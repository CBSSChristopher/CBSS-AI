export const BRAND = {
  ...
  title: "The Yard",
  stamp: "build 22 · one stage + activity",
} as const;
...
/** Bookmark for the floor. Alias workers must not 302 onto this host. */
export const YARD_PUBLIC = "https://floor.cbshippingsolutions.app";
