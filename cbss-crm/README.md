...
- The Tasks tab has a **Complete** button. Completing a task clears the follow-up, stores it on the contact under **Completed tasks**, and asks if you want to schedule another follow-up.
