...
export const EMAIL_TEMPLATES: EmailTemplate[] = [
  {
    ...
    when: "They just filled the form. No PDF yet.",
...
${SIGN}`,
  },
  {
    ...
    when: "CTE. You already called and texted.",
...
${SIGN}`,
  ...
  },
  {
    ...
    when: "Official PDF is going out. You have not really talked yet.",
...
${SIGN}`,
  },
  {
    ...
    when: "You already spoke. As promised, the PDF.",
    subject: "Your all inclusive proposal from CBShippingSolutions",
...
${SIGN}`,
  },
  {
    ...
    when: "You talked today. Short cover. Attach the PDF.",
...
${SIGN}`,
  },
  {
    ...
    when: "Bigger job after a call. Attach the PDF. No new price.",
    subject: "Your all inclusive proposal from CBShippingSolutions",
...
${SIGN}`,
  },
  {
    ...
    when: "They replied. You still need ZIP, grade, site, or destination.",
...
${SIGN}`,
  },
  {
    ...
    when: "You already sent a quote or proposal. They have not written back.",
...
${SIGN}`,
  },
  {
    ...
    when: "They got it and will look it over. Do not push.",
...
${SIGN}`,
  },
  {
    ...
    when: "They added it to a spreadsheet / will be in touch.",
    subject: "Re: Your all inclusive proposal from CBShippingSolutions",
    fields: ["firstName"],
    body: `Good Morning,
...
${SIGN}`,
  },
  {
    ...
    when: "The file went cold. This is a reconnect, not a first email.",
...
${SIGN}`,
  },
  {
    ...
    when: "Resend the same PDF. Do not write a new pitch.",
    subject: "Your all inclusive proposal from CBShippingSolutions",
    fields: ["firstName"],
    body: `{{firstName}},
