...
Paid Next Steps attaches `cbss-invoice/assets/CBSS-Next-Steps-After-Your-Order.pdf` as AgentMail `content` (base64). Do not set or use `NEXT_STEPS_PDF_URL` for attach.
