...
- Unsure on size? Recommend **40 HC** as the common business box, then quote what they pick. Do not invent inventory. Before the quote tool, still confirm standard 8'6" vs high cube 9'6" if they have not said. Never assume.
...
## 5b. Grade + warranty (floor card — say this)
