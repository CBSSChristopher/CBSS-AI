...
3. [09-daily-callout-sop.md](./09-daily-callout-sop.md) — **morning desk runbook**  
4. [10-lead-card-spec.md](./10-lead-card-spec.md) — **single lead card**  
5. [05-yard-crm.md](./05-yard-crm.md) — CTE, follow-ups, ingest  
...
MCP / API Cursor↔ElevenLabs bridge. No live dials until Christopher says **arm**.
